...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_SAMPLEPATH ";sp",                           "system/mame/samples",   OPTION_STRING,     "path to samplesets" },
	{ OPTION_ARTPATH,                                    "system/mame/artwork",   OPTION_STRING,     "path to artwork files" },
	{ OPTION_CTRLRPATH,                                  "system/mame/ctrlr",     OPTION_STRING,     "path to controller definitions" },
	{ OPTION_INIPATH,                                    "system/mame/ini;system/mame/ini/presets",     OPTION_STRING,     "path to ini files" },
	{ OPTION_FONTPATH,                                   "system/mame/",         OPTION_STRING,     "path to font files" },
	{ OPTION_CHEATPATH,                                  "system/mame/cheat",     OPTION_STRING,     "path to cheat files" },
	{ OPTION_CROSSHAIRPATH,                              "system/mame/crosshair", OPTION_STRING,     "path to crosshair files" },
	{ OPTION_PLUGINSPATH,                                "system/mame/plugins",   OPTION_STRING,     "path to plugin files" },
	{ OPTION_LANGUAGEPATH,                               "system/mame/language",  OPTION_STRING,     "path to language files" },
	{ OPTION_SWPATH,                                     "system/mame/software",  OPTION_STRING,     "path to loose software" },

	// output directory options
	{ nullptr,                                           nullptr,     OPTION_HEADER,     "CORE OUTPUT DIRECTORY OPTIONS" },
	{ OPTION_CFG_DIRECTORY,                              "states/mame/cfg",       OPTION_STRING,     "directory to save configurations" },
	{ OPTION_NVRAM_DIRECTORY,                            "states/mame/nvram",     OPTION_STRING,     "directory to save NVRAM contents" },
	{ OPTION_INPUT_DIRECTORY,                            "states/mame/inp",       OPTION_STRING,     "directory to save input device logs" },
	{ OPTION_STATE_DIRECTORY,                            "states/mame/sta",       OPTION_STRING,     "directory to save states" },

...
static INPUT_PORTS_START( phantasm )
	...
	PORT_DIPNAME( 0x0f00, 0x0000, DEF_STR( Coin_A ) )
...
/*  PORT_DIPSETTING(      0x0100, DEF_STR( 1C_1C ) )*/
	...
	PORT_DIPSETTING(      0x0000, DEF_STR( Free_Play ) )
	PORT_DIPNAME( 0xf000, 0x0000, DEF_STR( Coin_B ) )
...
static INPUT_PORTS_START( cybattlr )
	...
	PORT_DIPNAME( 0x0040, 0x0000, DEF_STR( Free_Play ) )
	PORT_DIPSETTING(      0x0040, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_SERVICE( 0x0080, IP_ACTIVE_LOW )
...
static INPUT_PORTS_START( kickoff )
	...
	PORT_DIPNAME( 0x0700, 0x0000, DEF_STR( Coinage ) )
